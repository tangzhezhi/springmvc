...
public class AndroidPushMessageSample {
    ...
    public static void main(String[] args) {
        ...
        try {
//        	     appid=2219327 userId=1000414150712059691 channelId=4531399570486995899 requestId=2269509725
            // 4. 创建请求类对象userId=1000414150712059691 channelId=4531399570486995899 requestId=2278587875
            // 手机端的ChannelId， 手机端的UserId， 先用1111111111111代替，用户需替换为自己的
            PushUnicastMessageRequest request = new PushUnicastMessageRequest();
            request.setDeviceType(3); // device_type => 1: web 2: pc 3:android
                                      // 4:ios 5:wp
            request.setChannelId(4531399570486995899L);
            request.setUserId("1000414150712059691");

            request.setMessage("汤汤汤汤");
