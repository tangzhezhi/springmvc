...
public class AuthenticationFilter extends AbstractCasFilter {
    ...
    /**
     * Which urls will be excluded. add#liqi
     */
    ...
    /**
     * Expand for exclude "/admin/", and this filter do nothing and filterChain continue.
     * @param serviceUrl
     * @return
     */
    private boolean exclude(final HttpServletRequest request){
    	...
    	//when contain the splitter, we should do something more.
    	//otherwise do simple judgment.
